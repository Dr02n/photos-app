...
router.get('/reset-password/:userId/:token', resetPassword.checkPasswordResetStatus, resetPassword.get);
router.post('/reset-password/:userId/:token', resetPassword.checkPasswordResetStatus, resetPassword.post);

router.get('/auth/github', require('./routes/auth-github').get);
router.get('/auth/github/callback', require('./routes/auth-github').getCallback);
